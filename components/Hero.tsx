...
export default function Hero({}: Props) {
  ...
  return (
    <div className='h-screen flex flex-col justify-center lg:ml-[310px] mx-[12%] font-bold'> {/* 124 extra from the left div */}
      ...
      <p className='font-bold md:text-[50px] text-[35px]'>I&apos;m <span className='text-transparent bg-clip-text bg-gradient-to-r from-[#CCFF00] to-[#00D1FF]'>Diego Villanueva</span></p>
