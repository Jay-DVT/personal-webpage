...
export default function Experience({}: Props) {
  ...
  return (
    <div className='min-h-screen flex flex-col md:text-left text-center max-w-7xl px-10 md:justify-evenly justify-evenly mx-auto items-center md:text-[15px] text-[12px]'>
